...
try {
    ...
    $sql = "
        ...
        WHERE 
            ...
            YEAR(createdAt) = YEAR(CURDATE()) AND  -- Filter by current year
            MONTH(createdAt) = MONTH(CURDATE())  -- Filter by current month
        GROUP BY 
            category
        ORDER BY 
            frequency DESC
    ...
    if ($result->num_rows > 0) {
        ...
        $response['message'] = 'No data found for this month.';
    }
